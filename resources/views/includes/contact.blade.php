<section class="w-full mb-20" id="contact">
  <div class="w-97 lg:w-11/12 xl:w-9/12 mx-auto bg-white rounded shadow-xl px-2 p-6 lg:px-6">
    <div class="mb-2">
      ...
      <p class="text-dark text-center mx-auto w-full lg:w-1/2">You can reach us back through this form, by emailing us or visiting our website and our team will get back to you shortly!</p>
    </div>
      <div class="flex flex-col lg:flex-row">
        <div class="w-full lg:w-4/12 flex justify-center items-center flex-col mt-6 lg:mt-0">
          <div class="mb-6">
            ...
            <div class="flex items-center">
              ...
              <p class="text-dark font-semibold hover:text-primary transition-colors duration-200 ease-in"><a href="http://nabastech.com/" target="_blank" rel="noopener noreferrer">https://nabastech.com</a></p>
            </div>
          </div>
        ...
        <form action="{{route('contact')}}" method="POST" class="flex w-full lg:w-8/12 flex-col lg:flex-row">
          ...
          <div class="w-full lg:w-1/2">
            ...
            <div class="input_container relative mb-4">
              <input class="input"text" name="company" id="company" placeholder="Company name">
            ...
            <div class="input_container relative mb-4 lg:mb-0">
              <input class="input"text" name="website" id="website" placeholder="Company website">
            ...
            <div class="w-full lg:w-1/2 flex flex-col justify-between items-start">
              <div class="w-full lg:w-10/12">
                ...
                <textarea name="message" id="message" rows="10" class="p-2 w-full border border-dark rounded text-dark font-semibold focus:outline-none focus:ring-1 focus:ring-dark"></textarea>
              </div>
