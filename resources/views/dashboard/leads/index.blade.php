...
<div class="flex flex-col items-center mb-10" >
  ...
  <div class="w-97 lg:w-11/12 bg-white py-6 px-1 md:p-6 rounded-lg">
    ...
    <div class="flex rounded-sm w-full bg-gray-100 mb-4 shadow text-sm lg:text-base">
      <div class="rounded-sm p-2 border-2 border-r-0 border-gray w-full lg:w-3/12">Name</div>
      ...
      <div class="rounded-sm p-2 border-2 border-r-0 bborder-gray w-2/12 hidden md:block">Company</div>
      <div class="rounded-sm p-2 border-2 border-r-0 bborder-gray w-2/12 hidden md:block">Website</div>
    ...
    @if($leads->count())
      ...
      <div class="flex rounded-sm w-full bg-gray-10 my-2 shadow-sm hover:shadow-md transition duration-150 ease-in-out text-sm lg:text-base">
        <div class="rounded-sm p-2 border-2 border-r-0 border-gray w-full lg:w-3/12 flex justify-between"><a href="{{ route('lead.show', $lead->id) }}">{{ $lead->name }}</a></div>
        ...
        <div class="rounded-sm p-2 border-2 border-r-0 bborder-gray w-2/12 hidden md:block overflow-hidden">{{ $lead->company}}</div>
        <div class="rounded-sm p-2 border-2 border-r-0 bborder-gray w-2/12 hidden md:block overflow-hidden">{{ $lead->website}}</div>
